...
export class SystemService extends EventEmitter {
    ...
    public async stop() {
        this.emit("beforeStop", this.serviceName, Date.now());
        ...
        return Promise.race([
            ...
            this.emit("afterStop", this.serviceName, Date.now());
